  ...
  en: {
    translation: {
      ...
      partner: {
        ...
        monitoring: 'Real-time monitoring of our ongoing manufacturing commitments for our major strategic clients.',
        capacity: 'Current Capacity',
        trackOrder: 'Track Order',
        strategicPartnerships: 'Client Partnerships',
        distinguished: 'OUR DISTINGUISHED CLIENTS',
        projectId: 'Project ID',
        efficiency: 'Efficiency',
        howItWorks: 'How It Works',
        simpleProcess: 'Simple Collaboration Process',
        ...
        joinNetwork: 'Join our network of successful clients and experience the future of apparel manufacturing.',
        becomePartner: 'Become a Client',
      ...
      about: {
        ...
        missionStatements: [
          ...
          'Build mutually beneficial long-term relationships with clients.'
        ],
        ...
        story: {
          ...
          p5: 'At Parahita Prima Sentosa, we grow together with our clients, maintain high standards in every process, and remain committed to excellence — delivered professionally, with a personal touch.'
        },
        stats: {
  ...
  id: {
    translation: {
      ...
      partner: {
        ...
        monitoring: 'Pemantauan real-time dari komitmen manufaktur kami yang sedang berlangsung untuk klien strategis utama kami.',
        capacity: 'Kapasitas Saat Ini',
        trackOrder: 'Lacak Pesanan',
        strategicPartnerships: 'Kemitraan Klien',
        distinguished: 'KLIEN TERPERCAYA KAMI',
        projectId: 'ID Proyek',
        efficiency: 'Efisiensi',
        howItWorks: 'Cara Kerjanya',
        simpleProcess: 'Proses Kerja Sama yang Sederhana',
        ...
        feedback: 'Tanggapan Klien',
        successStories: 'Kisah Sukses',
        getStarted: 'Mulai Sekarang',
        readyToScale: 'Siap meningkatkan',
        yourProduction: 'produksi Anda?',
        joinNetwork: 'Bergabunglah dengan jaringan klien sukses kami dan rasakan masa depan manufaktur pakaian.',
        becomePartner: 'Menjadi Klien',
      ...
      about: {
        ...
        story: {
          ...
          p5: 'Di Parahita Prima Sentosa, kami tumbuh bersama klien kami, mempertahankan standar tinggi dalam setiap proses, dan tetap berkomitmen pada keunggulan — yang disampaikan secara profesional, dengan sentuhan pribadi.'
        },
        stats: {
